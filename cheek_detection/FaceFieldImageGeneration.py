...
wb_r2 = openpyxl.load_workbook(r"C:\Users\horii\Desktop\sagyou\program\elderly_autocheek\A\10\practice2\before\excel\Eyebrows.xlsx")
ws_r2 = wb_r2["Sheet"]
...
wb_r3 = openpyxl.load_workbook(r"C:\Users\horii\Desktop\sagyou\program\elderly_autocheek\A\10\practice2\before\excel\Contours.xlsx")
ws_r3 = wb_r3["Sheet"]
...
wb_r4 = openpyxl.load_workbook(r"C:\Users\horii\Desktop\sagyou\program\elderly_autocheek\A\10\practice2\before\excel\nose.xlsx")
ws_r4 = wb_r4["Sheet"]
...
wb_r5 = openpyxl.load_workbook(r"C:\Users\horii\Desktop\sagyou\program\elderly_autocheek\A\10\practice2\before\excel\cheek.xlsx")
ws_r5 = wb_r5["Sheet"]
...
for f_name in glob.iglob(r"F:\ryouta\Program\Experiment\1019\A\Practice2\Image\before\original\*.jpg"):
    files.append(f_name)
...
for i in range(img_num):
    ...
    cv2.imwrite(r"C:\Users\horii\Desktop\sagyou\program\elderly_autocheek\A\10\practice2\before\cut\cut_img_" + str(i) + "_.jpg",cut_img)
    ...
    if (i == 0):
        ...
        cv2.imwrite(r"C:\Users\horii\Desktop\sagyou\program\elderly_autocheek\A\10\practice2\before\re\re_img_" + str(i) + "_.jpg",re_img)
    ...
    #処理後の画像を出力
    #画像を出力するファイルまでのパスを入力してください         
    cv2.imwrite(r"D:\ryouta\Program\Experiment\1019\A\Practice1\Image\playing\emotion_4\resize\re_img_" + str(i) + "_.jpg",re_img)
    """
...
wb2.save(r"C:\Users\horii\Desktop\sagyou\program\elderly_autocheek\A\10\practice2\before\excel\re_Eyebrows.xlsx")
#wb3.save(r"D:\ryouta\Program\1014_Pre_experiment\honda\ex\landmark\outfile\Re_CoordinatesData(Contours).xlsx")
wb3.save(r"C:\Users\horii\Desktop\sagyou\program\elderly_autocheek\A\10\practice2\before\excel\re_Contours.xlsx")
#wb4.save(r"D:\ryouta\Program\1014_Pre_experiment\honda\ex\landmark\outfile\Re_CoordinatesData(nose).xlsx")
wb4.save(r"C:\Users\horii\Desktop\sagyou\program\elderly_autocheek\A\10\practice2\before\excel\re_nose.xlsx")
wb5.save(r"C:\Users\horii\Desktop\sagyou\program\elderly_autocheek\A\10\practice2\before\excel\re_cheek.xlsx")
